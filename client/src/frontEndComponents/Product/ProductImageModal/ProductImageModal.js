...
const ProductImageModal = (props) => {
  ...
  return (
    <div className={styles.Modal} onClick={(e) => handleCloseClick(e, props.closeModal)}>
      <div className={styles.ModalContent}>
        <div className={styles.CloseButton} onClick={props.closeModal}></div>
        {props.directions.left ? renderLeftButton(props) : null}
        <ImageLoader className={styles.ModalImage} imageName={image.src} path="/images/products/" alt={image.alt} />
