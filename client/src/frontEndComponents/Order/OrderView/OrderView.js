...
import OrderPreviewItem from "../../Orders/OrderPreviewItem/OrderPreviewItem";
...
const OrderView = ({ order, style = {} }) => {
  ...
  return (
    <div style={style} className={styles.Order}>
      ...
      <OrderTotals showShipping={true} shipping={order.shipping} subtotal={order.subtotal} total={order.total}/>
    </div>
  );
};
