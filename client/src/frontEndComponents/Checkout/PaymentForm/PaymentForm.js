          ...
          <div className={styles.Form}>
            <form className={this.state.ready !== 3 ? styles.Hide : ""} onSubmit={this.handleSubmit}>
              ...
              <label className={styles.Label} htmlFor="name">
                Name on Card
                <input id="name" onChange={this.handleNameChange} value={this.state.name} className={styles.CardItem} />
              </label>
              <div>
                ...
                {this.state.errorMessage ? <div className={styles.Error}>
                ...
                <Button
                  ...
                  bold
                  float="Right"
                  text={this.state.buttonDisabled ? (
                    <React.Fragment>
