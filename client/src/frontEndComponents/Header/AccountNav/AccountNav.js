    ...
    return (
      <div>
        <nav className={styles.AccountNav}>
          <NavItem
            clickHandler={props.showLogin}
            name="Sign In"
          />
          <NavItem
            clickHandler={props.showRegister}
            name="Create Account"
          />
          <button className={styles.CartButton} onClick={() => props.history.push("/checkout/cart")}>
            <CartIcon />
      ...
      <nav className={styles.AccountNav}>
        <NavItem
          ...
          subcategories={[
            ...
            { _id: "3", path: "logout", name: "Sign Out", clickHandler: props.onLogout }
          ]}
        />
        <button className={styles.CartButton} onClick={() => props.history.push("/checkout/cart")}>
          <CartIcon />
