...
class Categories extends Component {
  ...
  componentDidMount() {
    ...
    api.get("/api/categories", { cancelToken: this.cancelGetRequest.token }, false, true)
      .then(res => {
  ...
  handleDeleteClick = () => {
    ...
    api.post("/api/categories/delete", filteredCats, { cancelToken: this.cancelDeleteRequest.token }, true, true)
      .then(res => {
        const categories = flattenCategories(res.data);
  ...
  handleAddClick = () => {
    ...
    api.post("/api/categories", { category: {} }, { cancelToken: this.cancelPostRequest.token }, true, true)
      .then(res => {
      ...
      return (
        <React.Fragment key={cat._id}>
          <div className={styles.Category}>
            <Checkbox handleSelect={this.handleSelect} isChecked={cat.selected} id={cat._id} />
