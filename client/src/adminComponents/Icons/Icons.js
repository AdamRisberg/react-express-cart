...
const Delete = ({ className, ...props }) => {
  return (
    <svg {...props} className={`${styles.Icon} ${className}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
...
const Image = ({ ...props }) => {
  return (
    <svg {...props} className={styles.Icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
