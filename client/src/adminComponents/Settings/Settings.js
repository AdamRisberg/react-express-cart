...
import StateSelect from "../../frontEndComponents/StateSelect/StateSelect";
...
class Settings extends Component {
  ...
  componentDidMount() {
    ...
    api
      .get("/api/settings", { cancelToken: this.cancelGetRequest.token }, true, true)
      .then(res => {
  ...
  handleSubmit = (e) => {
    ...
    api
      .put("/api/settings", this.state.settings, { cancelToken: this.cancelPutRequest.token }, true, true)
  ...
  handleImageSelect = (e) => {
    ...
    api
      .put("/api/settings/image?location=general", data, {
  ...
  handleDeleteImage = (image) => () => {
    ...
    api
      .delete(`/api/settings/image?location=general&file=${image.src}`, { cancelToken: this.cancelImageDeleteRequest.token }, true, true)
  ...
  render() {
    ...
    const image = this.state.settings.general.brand_image ? [{ src: this.state.settings.general.brand_image, alt: "" }] : []; 
