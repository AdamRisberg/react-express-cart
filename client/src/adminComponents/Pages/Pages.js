...
class Pages extends Component {
  ...
  componentDidMount() {
    ...
    api.get("/api/pages", {cancelToken: this.cancelGetRequest.token }, true, true)
      .then(res => {
  ...
  handleDeleteClick = () => {
    ...
    api.post("/api/pages/delete", filteredPages, { cancelToken: this.cancelDeleteRequest.token }, true, true)
      .then(res => {
  ...
  handleAddClick = () => {
    ...
    api.post("/api/pages", { page: {} }, { cancelToken: this.cancelPostRequest.token }, true, true)
      .then(res => {
      ...
      return (
        <React.Fragment key={page._id}>
          <div className={styles.Page}>
            <Checkbox handleSelect={this.handleSelect} isChecked={page.selected} id={page._id} />
